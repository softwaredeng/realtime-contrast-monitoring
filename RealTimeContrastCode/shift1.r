...
write.table(voteoobmatrix, file = "oobvotenormal10.txt",quote= FALSE,row.names=FALSE,col.names=FALSE)


write.table(votesum, file = paste(a,"votesum10.txt"),quote= FALSE,row.names=FALSE,col.names=FALSE)
write.table(s1votesum, file = paste(a,"s1votesum10.txt"),quote= FALSE,row.names=FALSE,col.names=FALSE)
write.table(votegt01, file = paste(a,"votegt0110.txt"),quote= FALSE,row.names=FALSE,col.names=FALSE)
write.table(votegt02, file = paste(a,"votegt0210.txt"),quote= FALSE,row.names=FALSE,col.names=FALSE)
write.table(votegt03, file = paste(a,"votegt0310.txt"),quote= FALSE,row.names=FALSE,col.names=FALSE)
write.table(votegt04, file = paste(a,"votegt0410.txt"),quote= FALSE,row.names=FALSE,col.names=FALSE)
write.table(votegt05, file = paste(a,"votegt0510.txt"),quote= FALSE,row.names=FALSE,col.names=FALSE)
write.table(votegt06, file = paste(a,"votegt0610.txt"),quote= FALSE,row.names=FALSE,col.names=FALSE)
write.table(votegt07, file = paste(a,"votegt0710.txt"),quote= FALSE,row.names=FALSE,col.names=FALSE)
write.table(votegt08, file = paste(a,"votegt0810.txt"),quote= FALSE,row.names=FALSE,col.names=FALSE)
write.table(votegt09, file = paste(a,"votegt0910.txt"),quote= FALSE,row.names=FALSE,col.names=FALSE)
write.table(p1, file = paste(a,"p110.txt"),quote= FALSE,row.names=FALSE,col.names=FALSE)
write.table(s1votegt01, file = paste(a,"s1votegt0110.txt"),quote= FALSE,row.names=FALSE,col.names=FALSE)
write.table(s1votegt02, file =paste(a, "s1votegt0210.txt"),quote= FALSE,row.names=FALSE,col.names=FALSE)
write.table(s1votegt03, file = paste(a,"s1votegt0310.txt"),quote= FALSE,row.names=FALSE,col.names=FALSE)
write.table(s1votegt04, file = paste(a,"s1votegt0410.txt"),quote= FALSE,row.names=FALSE,col.names=FALSE)
write.table(s1votegt05, file = paste(a,"s1votegt0510.txt"),quote= FALSE,row.names=FALSE,col.names=FALSE)
write.table(s1votegt06, file = paste(a,"s1votegt0610.txt"),quote= FALSE,row.names=FALSE,col.names=FALSE)
write.table(s1votegt07, file = paste(a,"s1votegt0710.txt"),quote= FALSE,row.names=FALSE,col.names=FALSE)
write.table(s1votegt08, file =paste(a, "s1votegt0810.txt"),quote= FALSE,row.names=FALSE,col.names=FALSE)
write.table(s1votegt09, file = paste(a,"s1votegt0910.txt"),quote= FALSE,row.names=FALSE,col.names=FALSE)
write.table(logsum, file = paste(a,"logsum10.txt"),quote= FALSE,row.names=FALSE,col.names=FALSE)
write.table(s1logsum, file = paste(a,"s1logsum10.txt"),quote= FALSE,row.names=FALSE,col.names=FALSE)
